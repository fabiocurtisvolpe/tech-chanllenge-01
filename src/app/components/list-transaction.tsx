        ...
        return (
            <div className="panel panel-default rounded-lg shadow-lg">
                ...
                <div className="d-flex justify-content-end">
                    <button type="button" className="btn btn-info m-lg-4 text-end" data-toggle="modal" data-target="#myModal" onClick={this.handleNewTransaction}>Nova
                        Transação
                    </button>
                </div>
                            ...
                            <tbody>
                                {this.transations.map((t, index) => (
                                    <tr key={index} className={this.addCollapse(index)} id="collapseTr">
                                        ...
                                        <td className={t.classAmount}>
                                            {this.formatAmount(t.amount)}
                                        </td>
                                        <td>{t.type}</td>
                                        <td>
                                            <button className="btn btn-success m-lg-1" title="Editar Transação" onClick={() => this.editTransation(t, index)}>
